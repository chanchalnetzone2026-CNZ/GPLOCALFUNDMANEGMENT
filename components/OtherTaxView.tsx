    ...
    const bodyHtml = `
      ...
      <div class="max-w-3xl mx-auto bg-white border-2 border-slate-900 rounded-2xl p-7 shadow-lg">
        ...
        <div class="border-b-2 border-slate-900 pb-4 mb-4 text-center space-y-1.5">
          ...
          <div class="pt-1">
            <div class="inline-block border border-emerald-300 bg-emerald-50 text-emerald-950 font-bold font-sans text-xs px-4 py-1.5 rounded-full uppercase shadow-xs leading-normal">
