          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-4 sm:p-6 animate-slide-up border-2 border-primary my-auto max-h-[92vh] flex flex-col overflow-hidden">
            ...
            <div className="overflow-y-auto flex-1 py-3 pr-1 space-y-4 my-1">
              <div id="receipt-print-area" className="printable-area p-5 sm:p-7 bg-white border-2 border-dashed border-primary-300 rounded-2xl space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 bg-slate-50 border border-slate-200 p-3 rounded-xl text-xs">
                  <div className="flex items-center justify-between sm:justify-start gap-2">
                    <span className="font-bold text-slate-800">कर मांग माह (Charged Period):</span>
                    <span className="bg-indigo-700 text-white px-2.5 py-1 rounded-md font-sans font-bold text-xs leading-normal inline-block">
                      {getChargedMonthLabel(viewingReceipt)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between sm:justify-start gap-2">
                    <span className="font-bold text-slate-800">प्राप्ति माह (Received Month):</span>
                    <span className="bg-emerald-700 text-white px-2.5 py-1 rounded-md font-sans font-bold text-xs leading-normal inline-block">
                    ...
                    <tbody className="divide-y divide-slate-100 font-medium text-slate-800">
                      <tr>
                        <td className="px-3 py-2">
                          <div className="font-semibold text-slate-900">मूल कर मांग / पूर्व बकाया (Tax Demand / Previous Dues)</div>
                          <div className="text-[11px] text-indigo-700 font-sans font-medium mt-0.5">
                      ...
                      {viewingReceipt.penalty !== undefined && viewingReceipt.penalty > 0 && (
                        <tr className="text-rose-700 font-semibold bg-rose-50/40">
                          ...
                          <td className="px-3 py-2 text-right font-mono font-bold">+₹{viewingReceipt.penalty.toLocaleString('en-IN')}</td>
                        </tr>
                      )}
                      {viewingReceipt.concession !== undefined && viewingReceipt.concession > 0 && (
                        <tr className="text-emerald-700 font-semibold bg-emerald-50/40">
                          ...
                          <td className="px-3 py-2 text-right font-mono font-bold">-₹{viewingReceipt.concession.toLocaleString('en-IN')}</td>
                        </tr>
                      )}
                      <tr className="bg-emerald-100/70 font-black text-emerald-900 border-t-2 border-emerald-300">
                        <td className="px-3 py-2">
                          <div className="font-bold">कुल प्राप्त भुगतान (Total Amount Paid & Received)</div>
                          <div className="text-[11px] text-emerald-800 font-sans font-medium mt-0.5">
