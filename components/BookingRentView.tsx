...
interface BookingRentViewProps {
  ...
  onClose?: () => void;
  isHindi?: boolean;
  initialSelectedBooking?: BookingRentRecord | null;
}
...
export const BookingRentView: React.FC<BookingRentViewProps> = ({
  ...
  onClose,
  isHindi = true,
  initialSelectedBooking = null,
}) => {
  const [activeTab, setActiveTab] = useState<'LIST' | 'CREATE'>('LIST');
  const [searchTerm, setSearchTerm] = useState<string>('');
  const [filterMode, setFilterMode] = useState<string>('ALL');
  const [selectedBookingForPrint, setSelectedBookingForPrint] = useState<BookingRentRecord | null>(initialSelectedBooking);
